 ...
 * Schema.
 * $Id: ConnectionTypeDescriptor.java,v 1.1 2005/07/22 14:13:12 mpelze2s Exp $
 */
...
/**
 * Class ConnectionTypeDescriptor.
 * 
 * @version $Revision: 1.1 $ $Date: 2005/07/22 14:13:12 $
 */
public class ConnectionTypeDescriptor extends org.exolab.castor.xml.util.XMLClassDescriptorImpl {
    ...
    public ConnectionTypeDescriptor() {
        super();
        ...
        handler = (new org.exolab.castor.xml.XMLFieldHandler() {
            ...
            {
                ConnectionType target = (ConnectionType) object;
        ...
        desc.setValidator(fieldValidator);
    } //-- global.pluginStructure.ConnectionTypeDescriptor()
    ...
    {
        return global.pluginStructure.ConnectionType.class;
